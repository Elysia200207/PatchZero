...
def eval(models_path, backend, snapshot, crop_x, crop_y, batch_size, alpha, epochs, start_lr, milestones, gpu):
    ...
    dataset = CustomDataset(root_dir='./adv_examples2007', split='test', transform=transform)
