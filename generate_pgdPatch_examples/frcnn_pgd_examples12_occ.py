...
def main():
    ...
    # 加载数据集
    dataset7train = VOCDetection('/gpfs/hulab/huangyifan/datasets', year='2007', image_set='train', download=False, transform=data_augmentation)
    dataset2train= VOCDetection('/gpfs/hulab/huangyifan/datasets', year='2012', image_set='train', download=False, transform=data_augmentation)
    dataset7val = VOCDetection('/gpfs/hulab/huangyifan/datasets', year='2007', image_set='val', download=False, transform=data_augmentation)
    dataset2val = VOCDetection('/gpfs/hulab/huangyifan/datasets', year='2012', image_set='val', download=False, transform=data_augmentation)
    dataset7test = VOCDetection('/gpfs/hulab/huangyifan/datasets', year='2007', image_set='test', download=False, transform=data_augmentation)
    dataset = torch.utils.data.ConcatDataset([dataset7train,dataset2train,dataset7val,dataset2val,dataset7test])
